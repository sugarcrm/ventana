...
SUGAR.Api = (function() {
    ...
    _.extend(HttpRequest.prototype, {
        ...
        execute: function(token, mdHash, upHash) {
            if (token) {
                ...
                if (this.params.iframe === true) {
                    this.params.data = this.params.data || {};
                    this.params.data["OAuth-Token"] = token;
                }
            }
            if (mdHash) {
                this.params.headers = this.params.headers || {};
    ...
    function SugarApi(args) {
        var _serverUrl, _platform, _keyValueStore, _clientID, _timeout, _refreshingToken, 
            _defaultErrorHandler, _externalLogin;
        ...
        return {
            ...
            call: function(method, url, data, callbacks, options) {
                ...
                if (this.isLoginRequest(url)) {
                    ...
                    request.execute(this.getOAuthToken());
                } else {
                    request.execute(this.getOAuthToken(), options.skipMetadataHash?null:this.getMetadataHash(), options.skipMetadataHash?null: this.getUserprefHash());
                }
             ...
             * });
             *
             * // Returns: http://localhost:8888/sugarcrm/rest/v10/Contacts/123/file/picture?format=sugar-html-json&platform=base
             * </code></pre>
             *
             ...
             * });
             *
             * // Returns: http://localhost:8888/sugarcrm/rest/v10/Contacts/123/file?platform=base
             * </code></pre>
             * @member SUGAR.Api
             */
             ...
             *      entire(optional): whether or not to use all records. this parameter respects filter
             *                        but overrides uid if set to true.
                ...
                return this.call(
                    ...
                    {'records':params.uid},
                    {
                        success: function(response) {
                            self.fileDownload(
                                self.buildURL(response.module_name,'export/'+response.id), 
                                callbacks, 
                                { iframe: $el }
                            );
                        }
