...
SUGAR.Api = (function() {
    ...
    function SugarApi(args) {
        ...
        _externalLogin = (args && args.externalLogin) || false;
        ...
        return {
             ...
             *      entire: (Boolean) if true, ignore uid parameter and get all records, subject to filter.
             ...
             * });
             *
             * // Returns: http://localhost:8888/sugarcrm/rest/v10/Contacts/export?filter%5B0%5D%5Ba%5D=b&oauth_token=XYZ
             * </code></pre>
             * @member SUGAR.Api
             */
             ...
             * @member SUGAR.Api
             */
            enum: function(module, field, callbacks, options){
