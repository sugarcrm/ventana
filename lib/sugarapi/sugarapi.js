    ...
    function SugarApi(args) {
        ...
        return {
            ...
            attachment: function(method, model, $files, callbacks) {
                var ajaxParams = { iframe: true, files: $files, processData: false, data: {oauth_token: _accessToken} }
                var uri = this.buildURL(model.module, "file", model, {format: "sugar-html-json"});
