...
SUGAR.Api = (function() {
    ...
    function SugarApi(args) {
        ...
        return {
             ...
             * @member SUGAR.Api
             */
            getMetadata: function(types, modules, callbacks, options) {
                if (!_.isArray(types)) {
                    SUGAR.App.logger.warn('`SUGAR.Api::getMetadata` has deprecated the `hash` parameter since 7.9' +
                        ' and will be removed in 7.10. Please update your code.');
                    [, types, modules, callbacks, options] = arguments;
                }
                ...
                if (options && options.getPublic) {
                    ...
                    callbacks = callbacks || {};
                    callbacks.success = _.wrap(callbacks.success, function (success, data, status) {
                        if (data) {
